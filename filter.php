...
<div class="genre" align="center">
	<label align=center>Choose Genre:</label>
...
<label align=center>Choose Year:</label><br>
<select name="year">
...
<input type="submit" value="Search" name="filter">
    ...
    <section id="content">
	<h2 align=center style="color:white">Movie List:</h2>
...
$sql="SELECT *FROM movielist where genre= '$genre' and year= '$year'";
...
while($row = mysqli_fetch_array($res)){
		...
		?>
                ...
                <li>
                    ...
                    <div class="info">
                                    <h3><a href = "product.php?id=<?php echo $row['id']; ?>" class="title" style="color:white"><?php echo $row['name']; ?></a></h3>
                        ...
                        <div class="actions">
	<a style="color:white" href = "addcart.php?pid=<?php echo $row['id']; ?>" name="add1">Add to cart</a>				
                        </div>
                    </div>
                </li>
			<?php } ?>
